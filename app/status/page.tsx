    ...
    <div className="grid-pattern">
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Overall Status */}
          <div className="card p-6 mb-8 border-emerald-500/30">
          ...
          {/* Uptime Note */}
          <div className="card p-6 bg-pico-navy/50">
            ...
            <p className="text-slate-500 text-sm">
              If you&apos;re experiencing issues with any of our services, please contact us at{' '}
              <a href="mailto:support@piconeuron.com" className="text-pico-accent hover:underline">
