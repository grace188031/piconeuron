    ...
    <div className="grid-pattern">
      ...
      <section id="contact" className="py-16 px-6">
        <div className="max-w-xl mx-auto">
          <h2 className="font-display text-2xl font-semibold mb-8 text-center animate-slide-up">
            Contact Us
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
            ...
            <div className="card card-hover p-5 flex items-start gap-3 animate-slide-up stagger-3">
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto">
          <div className="card card-hover p-8 border-amber-500/20 animate-slide-up">
